...
import { ApiResponse, SaveProductSpecResponse } from "@/app/lib/types/api";
...
export default function ProductSpecTestPage() {
  ...
  const [apiResponse, setApiResponse] =
    useState<SaveProductSpecResponse | null>(null);
...
- USB-C fast charging`,
  ...
  const handleSubmit = async (data: ProductSpec) => {
    ...
    try {
      ...
      const result: ApiResponse<SaveProductSpecResponse> =
        await response.json();
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl shadow-zinc-200/50 dark:shadow-zinc-950/50 border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">
                    Fill in the details below to create a comprehensive product
                    specification.
                  </p>
                </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl shadow-zinc-200/50 dark:shadow-zinc-950/50 border border-zinc-200 dark:border-zinc-800 p-6">
                ...
                <ul className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Add multiple features using the &quot;Add Feature&quot;
                      button
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
        ...
        <footer className="border-t border-zinc-200 dark:border-zinc-800 mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
              ProductSpecInput Component Test Page • Built with Next.js 16 &
              Tailwind CSS 4
            </p>
          </div>
        </footer>
